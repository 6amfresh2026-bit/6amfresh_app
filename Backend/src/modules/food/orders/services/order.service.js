...
// Sellers must confirm/reject an incoming order within this window, or it's
// auto-cancelled as "not accepted" (see expireUnacceptedOrders). Still
// configurable per FoodBusinessSettings.orderAcceptanceTimeMinutes (1-20 min).
const ORDER_ACCEPTANCE_WINDOW_SECONDS = 180;
